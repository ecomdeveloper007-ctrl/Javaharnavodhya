...
export const SEED_PAYMENT_SETTINGS: PaymentSettings = {
  ...
  gatewayMode: 'test',
  razorpayKeyId: 'rzp_test_NavodayaPachpadra80G',
  razorpayKeySecret: '••••••••••••••••••••••••',
  razorpayWebhookSecret: 'whsec_navodaya80g_pachpadra_live',
  successRedirectUrl: '/alumni/welfare?status=success',
  successCustomMessage: 'Thank you for your generous contribution to JNV Pachpadra Alumni Welfare & Vidyalaya Development. Your 80G tax exemption receipt has been generated.',
  failureRedirectUrl: '/alumni/welfare?status=failed',
  failureCustomMessage: 'Your transaction could not be processed. If funds were debited, they will be reversed by your bank within 3-5 working days.',
  webhookUrl: 'https://jnvpachpadra.org/api/donations/webhook',
